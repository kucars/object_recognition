...
tabletop_object_segmentation_online::TabletopSegmentation srv;
...
int main(int argc, char** argv)
{
  ...
  ////////////////////////////
   ...
   Hypotheses hypotheses;
	...
	tabletop_segmentation_client_ = n.serviceClient<tabletop_object_segmentation_online::TabletopSegmentation>("/tabletop_segmentation");

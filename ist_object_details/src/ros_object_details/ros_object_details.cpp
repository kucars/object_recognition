...
bool RosObjectDetails::refinePointCloudServiceCallback(ist_perception_msgs::GetRefinedPointCloud::Request  &req, ist_perception_msgs::GetRefinedPointCloud::Response &res )
{
...
bool RosObjectDetails::computeObjectDetailsServiceCallback(ist_perception_msgs::GetObjectDetails::Request &req, ist_perception_msgs::GetObjectDetails::Response &res)
{
...
ist_perception_msgs::Object RosObjectDetails::fillObjectTypeMessage(const ObjectDetails & object)
{
	sensor_msgs::PointCloud ros_point_cloud;
	sensor_msgs::PointCloud2 ros_point_cloud2;

	ist_perception_msgs::Object msg;
	...
	for(unsigned int i=0; i<object.regions.size(); ++i)
	{
		ist_perception_msgs::Region region_msg;
